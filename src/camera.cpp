...
void camera_controller::set_position(vec3& position){
    camera_model.position_camera = position;
}

void camera_controller::action_mouse_move(mat4 &camera_matrix_view)
{
    // Preconditions
...
void camera_controller::deactivate(){
    glfwSetInputMode(window->glfw_window, GLFW_CURSOR, GLFW_CURSOR_NORMAL);
    cursor_enabled = true;
}
void camera_controller::activate() {
    cursor_enabled = false;
}

// void camera_controller::action_keyboard(mat4 &)
// {
